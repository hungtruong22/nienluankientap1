...
.col-xs-1, .col-sm-1, .col-md-1, .col-lg-1, .col-xs-2, .col-sm-2,
	...
	.col-xs-5ths, .col-sm-5ths, .col-md-5ths, .col-lg-5ths, .col-lg-25ths,
	.col-md-25ths {
	position: relative;
	min-height: 1px;
	padding-right: 15px;
...
.col-lg-20ths, .col-md-20ths, col-sm-20ths {
	position: relative;
	min-height: 1px;
}
...
@media ( min-width : 992px) {
	.col-md-1, .col-md-2, .col-md-3, .col-md-4, .col-md-5, .col-md-6,
		...
		.col-md-5ths, .col-md-20ths, .col-md-25ths {
		float: left;
	}
	.col-md-20ths {
		width: 80%;
...
@media ( min-width : 1200px) {
	.col-lg-1, .col-lg-2, .col-lg-3, .col-lg-4, .col-lg-5, .col-lg-6,
		...
		.col-lg-5ths, .col-lg-20ths, .col-lg-25ths {
		float: left;
	}
	.col-lg-5ths {
		width: 20%;
											...
											<!-- <div class="quick-user">
												...
												<div class="inner-toggle">
													<ul class="login links">
														<li><a href="/dang-ky.html"><i
																class="fa fa-sign-in"></i> Đăng ký</a></li>
														<li><a href="/dang-nhap.html"><i
												...
												<div class="inner-toggle">
													<ul class="links">
														<li><a id="mobile-wishlist-total"
															href="lichsudatmonController" class="wishlist"><i
																class="fa fa-pencil-square-o"></i> Lịch sử đặt món</a></li>
														<li><a href="htgio" class="shoppingcart"><i
																class="fa fa-shopping-cart"></i> Đặt món</a></li>
													</ul>
												</div>
											</div>
...
--End-->
						...
						<section class="header-content clearfix">
							<div class="bg_header ">
								<div id="Header">
									<div class="visible-sm visible-xs col-sm-4 col-xs-3"></div>
									<div class="top top-search col-lg-3 col-md-3 col-sm-6 col-xs-6">
										<form action="timkiemController" method="post" class="search">
											<input value="${tk}" type="text" name="search" id="txtsearch"
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="box-html">
							<p>
								<img alt="" src="/Uploads/shop97/images/slide/banner_top.jpg" />
							</p>
				...
				<div class="row">
					<div class="col-md-3">
						...
						<div class="menu-product">
							...
							<ul class='level0'>
								<li class="child"><span><a
										href="htsanpham?maloai=all"> <i
											class='text-hover fa fa-arrow-circle-right'></i>Tất cả món ăn
									</a> </span> <span class='open-close'></span></li>
								<c:forEach items="${dsloai}" var="l">
									<c:if test="${maloai == l.maloai}">
										<li class="child"><span><a class="active"
												href="danhmucController?maloai=${l.maloai}"> <i
													class='text-hover fa fa-arrow-circle-right '></i>
													${l.tenloai}
											</a> </span> <span class='open-close'></span></li>
									</c:if>
									<c:if test="${maloai != l.maloai}">
										<li class="child"><span><a
												href="danhmucController?maloai=${l.maloai}"><i
													class='fa fa-arrow-circle-right'></i> ${l.tenloai}</a></span><span
						...
						<div class="card bg-light mb-3">
							<div
								class="card-header bg-success text-white text-uppercase newfood">Món
								ăn mới</div>
							<div class="card-body">
								<img class="img-fluid" src="${last.anh}" />
								<h5 class="card-title">${last.tenmonan}</h5>
								<p class="bloc_left_price">${last.gia}₫</p>
							</div>
						</div>
						<!--End-->
								...
								<c:forEach items="${dssanpham}" var="s">
									<div class="col-md-3 col-sm-3 col-xs-12">
										<div class="product-item 1000151360 products-resize">
											<div class="image">
												<a class="image-resize" href=""><img alt="anhsanpham"
													src="${s.anh}"></a>
											</div>
											<div class="name">
												<a href="maid=${s.mamonan}">${s.tenmonan}</a>
											</div>
											<div class="price">
												<span class="pro-price">${s.gia}₫</span>
											</div>
											<div class="addcart">
												<a class="add2cart"
		...
		<footer>
			<section>
				<div class="footer-top container">
					<div class="col-lg-12">
						<a href="/"><img class="logo-foot"
							alt="C&#212;NG TY TNHH PH&#193;T TRIỂN C&#212;NG NGHỆ RUNTIME"
							src="/Uploads/shop97/images/logo.png"></a>
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-5ths col-md-5ths col-sm-6 col-xs-6">
							<h4>Giới thiệu</h4>
							<ul class="footer-col">
								<li><a href="/gioi-thieu/ve-chung-toi.html">Về
										ch&#250;ng t&#244;i </a></li>
								<li><a href="/gioi-thieu/linh-vuc-hoat-dong.html">Lĩnh
										vực hoạt động </a></li>
								<li><a href="/lien-he.html"> Li&#234;n hệ với
										ch&#250;ng t&#244;i </a></li>
								<li><a href="/tin-tuc.html"> Tin tức - Sự kiện </a></li>
								<li><a href="/content/quy-dinh-bao-hanh-doi-tra.html">
										Quy định bảo h&#224;nh - đổi trả </a></li>
							</ul>
						</div>
						<div class="col-lg-5ths col-md-5ths col-sm-6 col-xs-6">
							<h4>Chăm s&#243;c kh&#225;ch h&#224;ng</h4>
							<ul class="footer-col">
								<li><a href="/content/huong-dan-mua-hang.html"> Hướng
										dẫn mua h&#224;ng </a></li>
								<li><a href="/content/qui-dinh-doi-tra.html"> Qui định
										đổi trả </a></li>
								<li><a href="/content/chinh-sach-ban-hang.html">
						...
						<div
							class="footer-box box-social col-lg-5ths col-md-5ths col-sm-6 col-xs-6">
							<div class="item">
								<h4>Facebook</h4>
								<div class="toggle-footer">
									<div class="fb-like-box"
										data-href="https://www.facebook.com/runtime.vn"
										data-width="289" data-height="190" data-colorscheme="dark"
