...
.res-name, .res-address, .res-phone_number{
	width: 100%;
    text-align: center;
    font-weight: bold;
}

.res-address, .res-phone_number{
	font-weight: 500;
}
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
						<div class="hoadon">
							<h1 class="heading-hd res-name">Cảng Coffee</h1>
							<h4 class="res-address">63 Lâm Hoằng - TP.Huế</h4>
							<h4 class="res-phone_number">SĐT: 0789659512</h4>
							<h2 class="heading-hd">Hóa đơn thanh toán</h2>
							<p style="font-weight: 500;" class="staff">Thời gian: ${tgian}</p>
							<h4 class="staff">Nhân viên: ${tennhanvien}</h4>
							
							
								<table border="2" margin-bottom="28px" class="table">
									<thead>
										<tr>
											<th scope="col" class="border-0 td-light can-giua hd-food_name">
												<div class="py-2 text-uppercase">Tên MA</div>
											</th>
											<th scope="col" class="border-0 td-light can-giua">
									...
									<tbody>
										 ...
										 <c:if test="${hoadonthanhtoan != null}"> 
											<c:forEach items="${hoadonthanhtoan}" var="h">
												<tr>
													<td class="can-giua">${h.getTenmonan()}</td>
													<td class="can-giua">${h.getGia()} ₫</td>
													<td class="can-giua">${h.getSoluongmua()}</td>
													<td class="can-giua">${h.getThanhtien()} ₫</td>
													<p style="display: none" >${ngaymua = h.getNgaymua()}</p>
								...
								<div class="tong-tien">
									<p class="totalcoin">Tổng tiền: ${tongtien} ₫</h3>
									<p class="totalcoin">Giá khuyễn mãi: ${giakm} ₫</h3>
									<p class="totalcoin">Thanh toán: ${thanhtoan} ₫</p>
								</div>
