...
.bg-form {
	background:
		url("https://img.freepik.com/free-vector/fast-food-black-background-poster_1284-14589.jpg?w=2000");
	width: 1110px;
	margin: auto;
	height: 640px;
}
...
<body>
			...
			<div class="col-md-12">
				<div class="header">
					<section class="top-link clearfix">
						<div class="">
							<div class="">
								<div class="col-md-12 can_nav flex-nav bg-nav">
	...
	<div class="container bg-form">
		<div id="logreg-forms">
			<form action="doimatkhauController" method="post" class="form-signup">
				<h1 class="h3 mb-3 font-weight-normal" style="text-align: center">
					Đổi mật khẩu</h1>
				<label>Tên đăng nhập:</label>
				 <input name="user" type="text"
					id="user-name" class="form-control" placeholder="Tendangnhap"
					value="${acc.tendn}" required="" autofocus="" readonly>
				<label>Mật khẩu hiện tại:</label> 
				<input name="pass" type="password" id="user-pass"
					class="form-control" placeholder="Matkhauhientai" required
					autofocus=""> 
				<p class="text-danger">${tbloimkht}</p>
				<label>Mật khẩu mới</label>
				 <input	name="newpass" type="password" id="user-repeatpass"
					class="form-control" placeholder="Matkhaumoi" required autofocus="">
				<label>Nhập lại mật khẩu mới</label>
				 <input name="renewpass" type="password" id="user-repeatpass" class="form-control"
					placeholder="Nhaplaimatkhaumoi" required autofocus="">
				<p class="text-danger">${tbloi}</p>
				<p class="text-success">${thanhcong}</p>
