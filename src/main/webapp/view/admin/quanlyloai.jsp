	...
	<div class="container">
		...
		<div class="table-wrapper">
			<div class="table-title bg-table">
				<div class="row">
					<div class="col-sm-6">
						<h1 class="heading-food_name">Danh Sách Loại</h1>
					</div>
				</div>
			</div>
						...
						<form action="themloaiController" method="post">
							...
							<div class="modal-body">
								<div class="form-group">
									<label>Mã Loại</label> <input name="maloai" type="text"
										class="form-control" required>
								</div>
								<div class="form-group">
									<label>Tên Loại</label> <input name="tenloai"
				...
				<div class="modal-dialog mw-600">
					<div class="modal-content">
						<form action="editloaiController" method="post">
							...
							<div class="modal-body">
								<div class="form-group">
									<label>Mã loại</label> <input name="mal"
										value="${type.maloai}" type="text" class="form-control"
										readonly required>
								</div>
								<div class="form-group">
									<label>Tên loại</label> <input name="tenl"
										value="${type.tenloai}" type="text" class="form-control"
										required>
								</div>
							</div>
							<div class="modal-footer can-ngang">
