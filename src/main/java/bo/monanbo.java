...
public class monanbo {
	...
	public void them(String mamonan, String tenmonan, Long gia, String anh, String maloai) {
		madao.them(mamonan, tenmonan, gia, anh, maloai);
	}

	public void sua(String mamonan, String tenmonan, Long gia, String anh, String maloai) {
	...
	public static void main(String[] args) {
		...
		ArrayList<monanbean> ds = sbo.getMonan();
